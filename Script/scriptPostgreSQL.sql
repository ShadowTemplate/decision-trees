drop database if exists classificationdata;
create database classificationdata;

create user decisiontreeid CREATEDB CREATEROLE PASSWORD 'dectreepassword';
GRANT ALL PRIVILEGES ON DATABASE classificationdata TO decisiontreeid;
...
CREATE TABLE iris
(
  sepallength numeric(10,2),
  sepalwidth numeric(10,2),
  petallength numeric(10,2),
  petalwidth numeric(10,2),
  classvalue character varying(100)
);

ALTER TABLE iris
  OWNER TO decisiontreeid;

  
CREATE TABLE playtennis
(
  outlook character varying(100),
  temperature numeric(10,2),
  umidity character varying(100),
  wind character varying(100),
  play character varying(100)
);

ALTER TABLE playtennis
  OWNER TO decisiontreeid;
